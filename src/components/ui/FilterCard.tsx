...
const CategoryCard: React.FC<Props> = ({ category, img, onSelect }: Props) => {
  ...
  return (
    <button
      ...
      className={`w-full py-[14px] flex justify-center items-center gap-4 border-[1px] rounded-md shadow-sm categoryCardShadow hover:scale-105 duration-200 ease-in-out`}
    >
