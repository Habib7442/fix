...
const Header = () => {
  ...
  return (
    <React.Fragment>
      {storeData && headerText && (
        <div
          style={{ background: storeData?.color1 }}
          className="w-full h-[35px] sm:h-[45px] flex justify-center items-center relative text-white"
        >
          <p className="text-[12px] sm:text-[14px] md:text-[17px] text-white-main font-semibold">
            {storeData?.texting?.heading1}
          </p>
        ...
        <div className="w-full max-w-[1000px] m-auto flex flex-col gap-4 lg:gap-2 py-8 lg:px-0 px-4 justify-center items-center">
          ...
          <div className="flex w-full justify-between items-center lg:px-0 px-8">
            ...
            <button onClick={toggleDrawer}>
              <RxCross1 className="text-[25px] sm:text-[30px] text-black cursor-pointer hover:opacity-70" />
            </button>
          </div>
          {/* shop logo -----------> */}
